<style>
  ...
  #research-x-practice-table tbody th {
    font-weight: initial;
    border-bottom: 1px solid rgb(242, 242, 242);
  }

  #research-x-practice-table tbody tr:last-of-type th {
    border-bottom: inherit;
  }

  /* #research-x-practice-table td,
  #research-x-practice-table thead th {
    text-align: center;
  } */
  ...
  /* #research-x-practice-table td.highlight {
